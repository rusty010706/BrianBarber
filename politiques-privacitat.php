...
<head>
  ...
  <title>Polítiques de Privacitat | BrianBarber</title>
...
<main class="main-content-index">
  <div class="content-index-container">
    <div class="content-box">
      <h2>Polítiques de Privacitat</h2>
      <p>D'acord amb el que estableix el Reglament (UE) 2016/679 del Parlament Europeu i del Consell (RGPD) i la Llei Orgànica 3/2018, de Protecció de Dades Personals i garantia dels drets digitals (LOPDGDD), us informem sobre com tractem les vostres dades.</p>
      
      <h3>1. Responsable del Tractament</h3>
      <p><strong>Nom:</strong> Brian Barber<br>
      <strong>Correu electrònic:</strong> info@brianbarber.cat<br>
      <strong>Adreça:</strong> Carrer del Mar 123, Badalona</p>

      <h3>2. Finalitats del Tractament</h3>
      <p>Les dades personals proporcionades pels usuaris a través de formularis de contacte, registre d'usuaris o reserves de cites, seran tractades per processar la vostra reserva, gestionar el vostre compte d'usuari i respondre a les vostres consultes. No s'enviaran comunicacions comercials no sol·licitades sense consentiment previ.</p>

      <h3>3. Legitimació</h3>
      <p>La base legal per al tractament de les vostres dades és la prestació del vostre consentiment explícit en acceptar aquesta política, i l'execució d'un contracte (la vostra cita) quan feu ús de la plataforma de reserves.</p>

      <h3>4. Conservació de les Dades</h3>
      <p>Les dades personals proporcionades es conservaran mentre es mantingui la relació comercial i l'interessat no en sol·liciti la supressió, i durant el temps necessari per al compliment de les obligacions legals oportunes.</p>

      <h3>5. Comunicació a Tercers</h3>
      <p>Les dades no se cediran a cap tercer aliè a Brian Barber, llevat d'obligació legal o quan sigui estrictament necessari per a la prestació del servei. El nostre sistema d'allotjament web compleix amb les garanties necessàries de seguretat.</p>

      <h3>6. Exercici de Drets (ARCO)</h3>
      <p>Teniu dret a obtenir confirmació sobre si estem tractant dades personals que us concerneixen. Teniu dret a <strong>Accedir</strong> a les vostres dades, <strong>Rectificar</strong> dades inexactes, <strong>Sol·licitar la supressió</strong> i oposar-vos al tractament. Envieu un correu a info@brianbarber.cat.</p>
    </div>
  </div>
</main>
