...
<head>
  ...
  <title> Contacte | BrianBarber</title>
...
<main class="main-contacte">
  <div class="box-contacte">
    <h2>Contacte</h2>
    <p>Tens algun dubte? Escriu-nos i et respondrem al més aviat possible.</p>
    ...
    <form action="#" method="POST" class="contacte-form">
      ...
      <div class="checkbox-group">
        <input type="checkbox" id="privadesa" name="privadesa" required>
        <label for="privadesa">Accepto la política de privadesa</label>
      </div>

      <button type="submit" class="btn-enviar-contacte">Enviar consulta</button>
    </form>
  </div>
</main>
