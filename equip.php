...
<main class="main-content-equip">
  <div class="box-equip-contenidor">
    <h2>El nostre equip</h2>
    <p>Coneix als professionals darrere de cada tall perfecte. Passió, experiència i el millor tracte per a tu.</p>
    ...
    <div class="equip-grid">
      <?php if(mysqli_num_rows($res_equip) > 0): ?>
        ...
        <div class="barber-card">
          ...
          <p><?php echo htmlspecialchars(!empty($empleat['especialitat_desc']) ? $empleat['especialitat_desc'] : "Passió, experiència i el millor tracte per a tu al cor de Badalona."); ?></p>
        </div>
        <?php endwhile; ?>
      <?php else: ?>
        <p class="text-empty-data">No hi ha treballadors actualment a la plantilla.</p>
      <?php endif; ?>
    </div>
  </div>
</main>
