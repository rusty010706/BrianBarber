...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['accion'])) {
    ...
    elseif ($accion == 'add_producto') {
        try {
            ...
            $imagen = isset($_POST['imagen']) && $_POST['imagen'] != '' ? $_POST['imagen'] : 'images/pomada_cabells.png';
 ...
 <nav class="nav-main">
      ...
      <div class="admin-section">
        ...
        <table class="admin-table">
          ...
          <tbody>
            ...
            <tr>
              <td><img src="<?php echo htmlspecialchars($p['imagen']); ?>" alt="img" class="admin-table-img"></td>
        ...
        <div class="admin-form-box">
            ...
            <form action="panell_serveis.php" method="POST" class="admin-form-col">
                ...
                <input type="text" name="imagen" placeholder="Ruta de l'imatge (opcional, per defecte usa images/pomada_cabells.png)" class="admin-input">
  ...
  <div class="footer-links-container">
    ...
    <div class="footer-col">
      ...
      <?php if (mysqli_num_rows($resultat_footer) > 0) {
