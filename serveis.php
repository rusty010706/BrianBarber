...
$sql_serveis = "SELECT * FROM servicios ORDER BY FIELD(categoria, 'Bàsic', 'Combinat', 'Detalls', 'Premium', categoria), precio ASC";
...
<head>
  ...
  <title>Serveis | BrianBarber</title>
...
<main class="main-content-serveis">
  <div class="box-serveis-contenidor">
    ...
    <p>Descobreix tot el que podem fer per la teva imatge. Escull el servei que millor s'adapti a tu.</p>
    ...
    <div class="serveis-grid">
      <?php if(mysqli_num_rows($res_serveis) > 0): ?>
        ...
        <?php endwhile; ?>
      <?php else: ?>
        <p class="text-empty-data">Encara no hi ha serveis disponibles. Si us plau, reviseu aviat.</p>
      <?php endif; ?>
    </div>

<div class="reserva-action-container">
  <a href="reserves.php" class="btn-reserva-gran">Reserva ja</a>
</div>
