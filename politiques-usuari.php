...
<head>
  ...
  <title>Avís Legal i Polítiques d'Usuari | BrianBarber</title>
...
<main class="main-content-index">
  <div class="content-index-container">
    <div class="content-box">
      <h2>Avís Legal i Polítiques d'Usuari</h2>
      <p>En compliment de la Llei 34/2002, de 11 de juliol, de Serveis de la Societat de la Informació i de Comerç Electrònic (LSSI-CE), informem que aquesta pàgina web és propietat de Brian Barber.</p>
      
      <h3>1. Dades Identificatives</h3>
      <p><strong>Titular:</strong> Brian Barber<br>
      <strong>NIF:</strong> 12345678Z<br>
      <strong>Adreça:</strong> Carrer del Mar 123, 08911 Badalona (Barcelona)<br>
      <strong>Correu electrònic:</strong> info@brianbarber.cat<br>
      <strong>Telèfon:</strong> +34 600 000 000</p>

      <h3>2. Condicions d'Ús</h3>
      <p>L'accés i ús d'aquest lloc web atribueix la condició d'Usuari, la qual cosa implica l'acceptació plena i sense reserves de totes i cadascuna de les disposicions incloses en aquest Avís Legal. L'Usuari es compromet a fer un ús adequat i lícit del lloc web i dels seus continguts.</p>

      <h3>3. Propietat Intel·lectual i Industrial</h3>
      <p>Tots els continguts d'aquest lloc web, incloent-hi, a títol enunciatiu i no limitatiu, el disseny, textos, imatges, logotips, codi font i qualsevol altre element subjecte a drets de propietat intel·lectual o industrial, són propietat del titular o de tercers que n'han autoritzat l'ús. Queda expressament prohibida la reproducció, distribució o transformació d'aquests sense autorització.</p>

      <h3>4. Exempció de Responsabilitat</h3>
      <p>El titular no es fa responsable dels possibles danys o perjudicis que es puguin derivar d'interferències, omissions, interrupcions, virus informàtics, avaries telefòniques o desconnexions en el funcionament operatiu del sistema electrònic; ni de retards o bloquejos en l'ús d'aquest. Així mateix, no es fa responsable del contingut d'enllaços externs a terceres pàgines.</p>

      <h3>5. Legislació Aplicable i Jurisdicció</h3>
      <p>Aquest Avís Legal es regeix per la legislació espanyola i europea vigent, en concret el RGPD i la LSSI-CE. Pel que fa a la resolució de conflictes o discrepàncies relacionades amb aquest lloc web, les parts se sotmeten als Jutjats i Tribunals de Barcelona.</p>
    </div>
  </div>
</main>
