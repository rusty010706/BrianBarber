...
<head>
  ...
  <title>Registre | BrianBarber</title>
...
<main>
  <div class="login-container">
    <div class="login-card">
      ...
      <p>uneix-te a brianbarber per reservar la teva cita</p>
      
      <form action="registrar.php" method="post">
        <div class="form-group">
          <label for="nombre">Nom</label>
          <input type="text" id="nombre" name="nombre" placeholder="el teu nom" required>
        </div>

        <div class="form-group">
          <label for="apellidos">Cognoms</label>
          <input type="text" id="apellidos" name="apellidos" placeholder="els teus cognoms" required>
        </div>
        
        <div class="form-group">
          <label for="email_reg">Correu electrònic</label>
          <input type="email" id="email_reg" name="correo" placeholder="exemple@correu.com" required>
        </div>
        
        <div class="form-group">
          <label for="password_reg">Contrasenya</label>
          <input type="password" id="password_reg" name="pass" placeholder="••••••••" required>
        </div>

        <div class="form-group">
          <label for="password_conf">Confirmar contrasenya</label>
          <input type="password" id="password_conf" name="pass_conf" placeholder="••••••••" required>
        <div class="form-group" style="margin-bottom: 5%;">
          <label class="custom-checkbox" for="politiques" style="align-items: flex-start;">
            <input type="checkbox" id="politiques" name="politiques" required>
            <span class="checkmark" style="flex-shrink: 0; margin-top: 0.1rem;"></span>
            <span>He llegit i accepto les <a href="politiques-privacitat.php" target="_blank">Polítiques de Privacitat</a> i l'<a href="politiques-usuari.php" target="_blank">Avís Legal / Usuari</a>.</span>
          </label>
        </div>
      ...
      <div class="links">
        <span class="create-account">ja tens un compte? <a href="accedir.php">iniciar sessió</a></span>
      </div>
    </div>
  </div>
</main>
