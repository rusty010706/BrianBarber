  ...
  <div class="login-card">
    ...
    <form action="login.php" method="post">
      <div class="form-group">
        ...
        <input type="email" id="email-accedir" name="correo" placeholder="exemple@correu.com" required>
      </div>
      
      <div class="form-group">
        <label for="password">Contrasenya</label>
        <input type="password" id="password-accedir" name="password" placeholder="••••••••" required>
      </div>
    ...
    <div class="links">
      <a href="/contra-oblidada.php" class="forgot-pass">Has oblidat la contrasenya?</a>
      <span class="create-account">No tens compte? <a href="/registre.php">Crear un compte</a></span>
    </div>
  </div>
</main>
